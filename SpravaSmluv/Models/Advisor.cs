...
namespace SpravaSmluv.Models
{
    ...
    public class Advisor
    {
        ...
        [Required(ErrorMessage = "Musíte vypnit Přijmení!"), RegularExpression(@"^[a-zA-Z\u0100-\u017F\u0180-\u024F\u1E00-\u1EFF\u00C0-\u00FF]+$", ErrorMessage = "Ujistěte se, že přijmení začíná velkým písmenem a je ve správném formátu!")]
